...
async function main() {
  await verify('0x8166041D01dac30C19519CB9986576C7cdc8B789', ["DropGenArt", "DGA", "0xFD78F7E2dF2B8c3D5bff0413c96f3237500898B3", 0, "0xFD78F7E2dF2B8c3D5bff0413c96f3237500898B3", script]);
}
...
async function verify(address, args) {
  try {
    return await hre.run('verify:verify', {
      ...
      contract: 'contracts/DropGenerativeArt.sol:DropGenerativeArt',
    });
  } catch (e) {
